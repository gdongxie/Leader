...
public class ReCreateGestureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActvityManager.activityList.add(ReCreateGestureActivity.this);
    ...
    private void init() {
        aCache = ACache.get(ReCreateGestureActivity.this);
    ...
    private void setLockPatternSuccess() {
        Intent intent = new Intent(ReCreateGestureActivity.this, MainActivity.class);
    ...
    private enum Status {
        //默认的状态，刚开始的时候（初始化状态）
        DEFAULT(R.string.recreate_gesture_default, R.color.grey_a5a5a5),
        //第一次记录成功
